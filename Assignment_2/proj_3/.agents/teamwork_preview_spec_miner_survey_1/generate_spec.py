...
spec_content = r"""# CRISP-DM Clustering & Autoresearch System
...
output_path = "/Users/divdhingra-personal/Desktop/CMPE255_DataMining/Assignment_2/proj_3/.agents/teamwork_preview_spec_miner_survey_1/spec_report.md"
with open(output_path, "w", encoding="utf-8") as f:
    f.write(spec_content.strip() + "\n")

print(f"Successfully wrote {len(spec_content)} characters to {output_path}")
